...
<!--navbar-->
<div class="container" id="wf_div">
    <nav class="navbar navbar-default navbar-custom">
        <ul class="nav navbar-nav navbar-left">
            <li><a href="#" role="button" id="addblock" onclick="addblock_box()">Add Block</a></li>
            <li><a href="#" role="button" id="copy_popup_button" onclick="copy_service()">Copy Service</a></li>
        </ul>
        <ul class="nav navbar-nav navbar-right">
            <li><a href="#" role="button" type="submit" id="save_model" onclick="save_model()">Save Model</a></li>
            <li><a href="#" role="button" type="submit" id="final_model" onclick="finalize_model()">Set Interactions</a></li>
            <li id="wf"><a href="#" role="button" type="submit" id="create_wf" onclick="create_workflow()">Create Workflow</a></li>
        </ul>
    </nav>
</div>
...
<!--service lists and add block & specification popups-->
<div class="container-fluid" id="fluid">
    <h2 id="sel_act_tag" align="center">Select Category, Sub-Category and Service</h2><br /><br />
    <form id="flowchart" class="form-horizontal">
        <div class="row">
            ...
            <div class="form-group row-md-4">
                <span>
                <button id="add" class="btn btn-primary" form="flowchart" disabled onclick="create_box(0,0);">Add</button>
            </span>
            </div>
        </div>
        ...
        <div id="add_block_popup" class="modal">
            ...
            <div class="modal-content">
                ...
                <div id="addblock_footer" class="modal-footer">
                    ...
                    <button class="btn btn-default" id="addblock_finish" type="button" disabled>Finish</button>
                    <button class="btn btn-danger" id="addblock_cancel" type="button">Cancel</button>
                </div>
            </div>
        </div>
        ...
        <div id="myModal" class="modal">
            ...
            <div class="modal-content">
                    ...
                    <form name="requirement_form" id="req_form">
                        ...
                        <table class="req_table">
                            ...
                            <tr>
                                <td></td>
                                <td colspan="2">
                                    <label class="req_label_heading" id="Service_Name"></label>
                                </td>
                                <td></td>
                            </tr>
                            <!----------------------service cagtegory--------------------->
                            <tr>
                                <td colspan="2">
                                    <label id="s_cat" class="req_label req_lbl_h" for="Service_Category">Service Category</label>
                                </td>
                                <td colspan="2">
                                    <input class="req_inp" type="text" id="Service_Category" name="Service_Category">
                                </td>
                            </tr>
                            <!----------------------Location--------------------->
                            <tr>
                                <td></td>
                                <td colspan="2">
                                    <label class="req_label_heading req_lbl_h" id="Location">Location</label>
                                </td>
                                <td></td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <label class="req_label" for="Latitude">Latitude</label>
                                    <input class="req_inp" type="text" id="Latitude" name="Latitude">
                                </td>
                                <td colspan="2">
                                    <label class="req_label" for="Longitude">Longitude</label>
                                    <input class="req_inp" type="text" id="Longitude" name="Longitude">
                                </td>
                            </tr>
                            <!----------------------Radius--------------------->
                            <tr>
                                <td>
                                    <label class="" id="Radius">Radius</label>
                                </td>
                                <td colspan="2">
                                    <label class="req_label" for="val_radius">Value</label>
                                    <input class="req_inp" type="text" id="val_radius" name="val_radius">
                                </td>
                                <td>
                                    <label class="req_label" for="unit_radius">Unit</label>
                                    <input class="req_inp" type="text" id="unit_radius" name="unit_radius">
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td></td>
                                <td colspan="2">
                                    <label class="req_label_heading req_lbl_h" id="Availability">Availability</label>
                                </td>
                                <td></td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <label class="req_label" for="val_avail">Value</label>
                                    <input class="req_inp" type="text" id="val_avail" name="val_avail">
                                </td>
                                <td  colspan="2">
                                    <label class="req_label" for="unit_avail">Unit</label>
                                    <input class="req_inp" type="text" id="unit_avail" name="unit_avail">
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td></td>
                                <td colspan="2">
                                    <label class="req_label_heading req_lbl_h" id="Hardware_Requirement">Hardware_Requirements</label>
                                </td>
                                <td></td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <label class="req_label" for="CPU">CPU</label>
                                    <input class="req_inp" type="text" id="CPU" name="CPU">
                                </td>
                                <td  colspan="2">
                                    <label class="req_label" for="Network">Network</label>
                                    <input class="req_inp" type="text" id="Network" name="Network">
                                </td>
                            </tr>

                            <tr>
                                <td>
                                    <label class="" id="RAM">RAM</label>
                                </td>
                                <td colspan="2">
                                    <label class="req_label" for="val_ram">Value</label>
                                    <input class="req_inp" type="text" id="val_ram" name="val_ram">
                                </td>
                                <td>
                                    <label class="req_label" for="unit_ram">Unit</label>
                                    <input class="req_inp" type="text" id="unit_ram" name="unit_ram">
                                </td>
                            </tr>

                            <tr>
                                <td>
                                    <label class="" id="external_storage">External Storage</label>
                                </td>
                                <td colspan="2">
                                    <label class="req_label" for="val_ext">Value</label>
                                    <input class="req_inp" type="text" id="val_ext" name="val_ext">
                                </td>
                                <td>
                                    <label class="req_label" for="unit_ext">Unit</label>
                                    <input class="req_inp" type="text" id="unit_ext" name="unit_ext">
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td></td>
                                <td colspan="2">
                                    <label class="req_label_heading req_lbl_h" id="Software_Requirement">Software_Requirements</label>
                                </td>
                                <td></td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <label class="req_label" for="OS">OS</label>
                                    <input class="req_inp" type="text" id="OS" name="OS">
                                </td>
                                <td  colspan="2">
                                    <label class="req_label" for="Package_List">Package List</label>
                                    <input class="req_inp" type="text" id="Package_List" name="Package_List">
                            ...
                            <tr>
                                <td></td>
                                <td colspan="2">
                                    <label class="req_label_heading">Services</label>
                                </td>
                                <td></td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    <label id="s_inp" class="req_label req_lbl_h" for="Service_Input">Service Input</label><br>
                                    <input style="width: 70%;" class="req_inp" type="text" id="Service_Input" name="Service_Input">
                                </td>
                                <td colspan="2">
                                    <label id="s_out" class="req_label req_lbl_h" for="Service_Output">Service Output</label><br>
                                    <input style="width: 70%;" class="req_inp" type="text" id="Service_Output" name="Service_Output">
                                </td>
                                <td>
                                    <label id="s_typ" class="req_label req_lbl_h" for="Service_Type">Service Type</label><br>
                                    <input style="width: 70%;" class="req_inp" type="text" id="Service_Type" name="Service_Type">
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="2">
                                    <label id='deply' class="req_label req_lbl_h" for="Deployable">Deployable</label>
                                    <input class="req_inp" type="text" id="Deployable" name="Deployable">
                                </td>
                                <td  colspan="2">
                                    <label id="urilist" class="req_label req_lbl_h" for="URI">URI</label>
                                    <input class="req_inp" type="text" id="URI" name="URI">
                                </td>
                            </tr>
                        </table>
                    </form>
                ...
                <div class="modal-footer">
                    <button class="btn btn-primary" id="req_submit_button" type="button" value="Submit">Submit</button>
                </div>
            </div>
        ...
        <div id="copy_service" class="modal">
            <!-- Modal content -->
            <div class="modal-content" id="cs_content">
                <div class="modal-header">
...
//        $('.req_inp').val('hello');
    ...
    function requirement_button_func(){
        req_button_set.click(function(){
            ...
            sn.innerHTML = text_array[box_id]; //to display name of service in popup

            /*save user from setting specifications of copied services
    ...
    function copy_service(){ //setup for copying service
...
//        }
    ...
    function element_val(i,index,switcher){
        ...
        switch(index) {
            case 0: case 5: case 6: case 7: case 8: case 9: //service category/sinp/sout/styp/depl/uri
        {
            xml = xml +
            req_val_init();
            break;
        }
            case 1: //location -- lat/long + radius
            {
                xml = xml +
                '<' + i + '>\n' +
